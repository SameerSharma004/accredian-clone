...
const LeadForm = ({ onClose }: LeadFormProps) => {
  ...
  return (
    <div className="fixed inset-0 z-100 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-5xl bg-white rounded-4xl shadow-[0_32px_64px_rgba(0,0,0,0.2)] flex flex-col md:flex-row animate-in zoom-in duration-300">
        <div className="hidden md:block w-5/12 relative bg-[#1A73E8] rounded-l-4xl overflow-hidden">
          <Image
            src="/hero-image.png"
            ...
            <div className="max-w-md mx-auto space-y-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className="w-full bg-gray-50 border-2 border-gray-100 rounded-2xl px-5 py-4 focus:border-[#1A73E8] focus:bg-white outline-none transition-all font-bold text-gray-900"
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      type="tel"
                      onChange={handleChange}
                      className="w-full bg-gray-50 border-2 border-gray-100 rounded-2xl pl-20 pr-5 py-4 focus:border-[#1A73E8] focus:bg-white outline-none transition-all font-bold text-gray-900"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div className="space-y-1.5 overflow-visible">
                    <CustomSelect
                      ...
                      onChange={(val) => handleSelectChange("deliveryMode", val)}
                      required
                    />
                  </div>
                  <div className="space-y-1.5">
                ...
                <button
                  disabled={loading}
                  type="submit"
                  className="w-full bg-[#1A73E8] text-white py-5 rounded-2xl font-black text-lg tracking-widest uppercase hover:bg-blue-700 transition-all shadow-xl shadow-blue-200 active:scale-95 flex items-center justify-center gap-3 disabled:opacity-50"
                >
                  {loading ? (
